        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href={`mailto:${EMAIL_ADDRESS}`} className="text-gray-600 dark:text-gray-400 hover:text-blue-500 transition-colors">
                <FaEnvelope size={20} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-2">Email: {EMAIL_ADDRESS}</p>
